...
import { IconBriefcase, IconMapPin, IconCheck, IconUpload } from '@/icons'
  ...
  return (
    <main className="bg-[#F0EDE6]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-2xl">
            <div className="inline-flex items-center gap-2 bg-white/10 rounded-full px-4 py-1.5 mb-6">
              <IconBriefcase className="w-3.5 h-3.5 text-[#7BA38C]" />
              <span className="text-xs font-semibold text-[#A8C4B4]">Join Our Team</span>
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold mb-4" style={{ fontFamily: 'Nunito, sans-serif' }}>Make a difference every day</h1>
            <p className="text-[#C4B8AC] leading-relaxed">Join the InitialCare family and build a rewarding career in care. We invest in our people with training, support, and real opportunities to grow.</p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 lg:py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-[#3A3028] mb-6" style={{ fontFamily: 'Nunito, sans-serif' }}>Current Vacancies</h2>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex flex-wrap gap-2 mb-2">
                      <span className="text-xs font-semibold bg-[#EBF2EE] text-[#5E8A72] px-3 py-1 rounded-full">{job.type}</span>
                    ...
                    {selectedJob === job.id && (
                      <motion.ul initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} className="space-y-1.5 mt-3">
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    ...
                    <button
                      ...
                      className="px-4 py-2 rounded-full bg-[#7BA38C] text-white text-xs font-bold hover:bg-[#5E8A72] transition-colors"
                    >
                      Apply Now
                    </button>
                  </div>
          ...
          <div id="apply-form">
            {submitted ? (
              <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white rounded-2xl p-10 text-center shadow-sm max-w-md mx-auto">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-white rounded-2xl p-6 lg:p-10 shadow-sm max-w-3xl mx-auto">
                <h2 className="text-xl font-bold text-[#3A3028] mb-6" style={{ fontFamily: 'Nunito, sans-serif' }}>Apply Now</h2>
